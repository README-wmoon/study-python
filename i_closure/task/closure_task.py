...
def set_post():
    ...
    return {'insert':insert, 'read': read, 'select_all':select_all, 'select': select, 'update': update, 'delete': delete}

post_service = set_post()
print(post_service.get('insert')(title="제목3", content="제목임"))
# print(post_service.get('select_all')())
print(post_service.get('update')(number=6, title="제목3", content="제목이당", file='파일임'))
# print(post_service.get('select_all')())
print(post_service.get('delete')(6))
print(post_service.get('select_all')())
# print(post_service.get('select_all')())